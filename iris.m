classdef iris < matlab.apps.AppBase
    ...
    methods (Access = private)
            ...
            switch answer.Text
                ...
                case 'Spider Plot'
                    ...
                    for i=classes'
                        ...
                        maxx=radarplotOUT(ax1,{nanmean((values2),1)},...
        ...
        % Callback function: Image20, load_html
        ...
        % Callback function: Image21, load_table
        function Image21Clicked(app, event)
            ...
            app.ButtonPanel.Position = [11 35 252 393];
        ...
        function ClassifyButton_3Pushed(app, event)
            ...
            a='<p style="font-family:arial;"><b>'
            b='<span style="color:rgb('
            c=');"> Class:' 
            ...
            %str = strjoin(app.models.(sec).classes,{', '});
            for iz=1:length(app.models.(sec).classes)
                
                
                c1=num2str(colors(iz,1)*255)+","
                c2=num2str(colors(iz,2)*255)+","
                c3=num2str(colors(iz,3)*255)
                str=append(str,sprintf('%s%s%s%s%s%s', b,c1,c2,c3,...
                    c,app.models.(sec).classes{iz}));
            end
            %app.Label_13.Text= ['Classes:' str];
            %app.Label_13.Position=[348,37,615,50]
            %app.Label_13.Interpreter='html';
            app.classes_res.HTMLSource=str+e;
            ...
            for i=1:size(app.indices,1)
                ...
                res=app.models.(sec).predictFcn(array2table(vals,'VariableNames',app.models.(sec).RequiredVariables));
                disp(['Row ' num2str(app.indices(i,2)) ' classification result is ' num2str(res) ])
                
                %app.Label_13.Text=string(app.models.(sec).classes{1});
                %app.Class2Label_2.Text=string(app.models.(sec).classes{2});
                
                [n,result] = ismember(num2cell(num2str(res)),app.models.(sec).classes)%find([app.models.(sec).classes]==app.models.(sec).classes{res});
                
%                 if length(stds)*0.5<sum(stds>stdsT)
%                     res=-1;
%                 end
                 
                  s = uistyle('BackgroundColor',colors(result,:),'FontWeight','Bold','FontColor','white');
                 
                  addStyle(app.UITable3,s,'row',app.indices(i,1));
                  app.TrueClass(end+1)=app.models.(sec).pseudo_classes{result};
                  %app.Class2Label_2.FontColor=colors(res,:)
        ...
        % Callback function: Image21_2, load_single
        ...
        function Classify_2ButtonPushed(app, event)
            ...
            app.NaNLabel_8.Text=num2str(res)%app.models.(sec).classes{res+1};
        ...
        % Button pushed function: SyntheticDataButton
        function SyntheticDataButtonPushed(app, event)
            ...
            switch answer
                case 'Continue'
                    ...
                    selection = uiconfirm(app.GliomaIDHMutationDiagnosisToolUIFigure,'Select the method','Select Synthetic Data Generator Method',...
                        'Options',{'ADASYN','ASUWO',...
                    ...
                    for i=responsesUn(~isnan(responsesUn))'
                        ...
                        ts=-1;
                        responseBuff(response==i)=ts;
                        responseBuff(response==id)=1;
                        
                    switch selection
                        case 'ADASYN'
                            responseBuff(responseBuff==-1)=0;
                            ts=0;
                            [inp,lbl]=ADASYN(table2array(values),(responseBuff));
                        case 'ASUWO'
                            [inp, lbl] = ASUWO(table2array(values), responseBuff, 1 , 3, 5,5)
                        case 'SMOTE'
                            [inp ,lbl] = SMOTE(table2array(values), responseBuff)
                        case 'Borderline SMOTE'
                            [border_min, inp, lbl] = BorSMOTE(table2array(values), responseBuff, 5)
                        ...
                        if size(lbl)==0
                            ...
                            str=['Data is not-well balanced. Class= ' num2str(i) ', now has  ' num2str(sum(lbl==i))  ' entries.' ];
                        end
                        ...
                        selection2 = uiconfirm(app.GliomaIDHMutationDiagnosisToolUIFigure,str,'ADASYN',...
                            'Icon','success');
                    ...
                    zer=zeros(size(inp2,1),size(app.UITable2.Data,2))
                    
                    zer(:,[app.trainerPredictors app.trainerResp(1,2)])=[inp2 lbl2]
        ...
        function ModelsListBox_5ValueChanged(app, event)
            ...
            app.Label_12.Text=app.DefMassmodels.(value).classes{1};
            ...
            app.reqVars=inds;
            if ~isempty(find(inds==0, 1)) || app.DefMassmodels.(value).CRLB~=-1
        ...
        % Button pushed function: ExportClassesButton_4
        function ExportClassesButton_4Pushed(app, event)
            
        end

        % Button pushed function: statisticaltests
        function statisticaltestsButtonPushed(app, event)
             
            try
                app.trainerPredictors
                app.trainerResp
            catch
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ButtonPanel.Position = [513 35 252 509];
            ...
            app.progressbar.Position = [68 282 127 35];
            ...
            app.LoadButton.Position = [76 433 100 34];
            ...
            app.ClassifyButton.Position = [76 366 100 35];
            ...
            app.ExportClassesButton.Position = [76 79 102 38];
            ...
            app.Image10.Position = [15 29 28 22];
            ...
            app.BacktoMainMenuLabel_2.Position = [48 24 103 35];
            ...
            app.ProcessingLabel.Visible = 'off';
            app.ProcessingLabel.Position = [58 320 139 27];
            ...
            app.ModelsListBox_3Label.Position = [1 244 47 22];
            ...
            app.ModelsListBox_3.Position = [63 135 190 133];
            ...
            app.LoadButton_4.Position = [96 413 52 20];
            ...
            app.Tree.Position = [1 471 172 202];
            ...
            app.AdvancedUser.Position = [172 -7 1336 680];
            ...
            % Create SyntheticDataButton
            app.SyntheticDataButton = uibutton(app.TrainingPanel, 'push');
            app.SyntheticDataButton.ButtonPushedFcn = createCallbackFcn(app, @SyntheticDataButtonPushed, true);
            app.SyntheticDataButton.BackgroundColor = [0.502 0.502 0.502];
            app.SyntheticDataButton.FontWeight = 'bold';
            app.SyntheticDataButton.FontColor = [1 1 1];
            app.SyntheticDataButton.Position = [727 503 119 31];
            app.SyntheticDataButton.Text = {'Synthetic Data'; ''};
            ...
            app.PREDICTORSListBox.Position = [43 211 250 118];
            ...
            app.predictor.Position = [43 123 250 37];
            ...
            app.ApplyCRLBThresholdMRSpectroscopyButton.Position = [42 89 241 25];
            ...
            app.Selectsubtab.BackgroundColor = [1 1 1];
            app.Selectsubtab.FontName = 'Arial';
            app.Selectsubtab.FontWeight = 'bold';
            app.Selectsubtab.FontColor = [0.149 0.149 0.149];
            app.Selectsubtab.Position = [22 51 133 31];
            app.Selectsubtab.Text = 'SelectSubTab';

            % Create statisticaltests
            app.statisticaltests = uibutton(app.Panel_3, 'push');
            app.statisticaltests.ButtonPushedFcn = createCallbackFcn(app, @statisticaltestsButtonPushed, true);
            app.statisticaltests.BackgroundColor = [1 1 1];
            app.statisticaltests.FontName = 'Arial';
            app.statisticaltests.FontWeight = 'bold';
            app.statisticaltests.FontColor = [0.149 0.149 0.149];
            app.statisticaltests.Visible = 'off';
            app.statisticaltests.Position = [164 51 147 33];
            app.statisticaltests.Text = 'Perform Statistical Tests';
            ...
            % Create load_html
            app.load_html = uihtml(app.TrainerTab);
            app.load_html.DataChangedFcn = createCallbackFcn(app, @Image20Clicked, true);
            app.load_html.Visible = 'off';
            app.load_html.Position = [652 290 141 99];
            ...
            app.TableEntryLabel.Position = [127 405 131 43];
            ...
            app.SingleDataPointEntryLabel.Position = [100 229 162 63];
            app.SingleDataPointEntryLabel.Text = 'Single Data Point Entry';

            % Create load_table
            app.load_table = uihtml(app.ClassifierMainPanel);
            app.load_table.DataChangedFcn = createCallbackFcn(app, @Image21Clicked, true);
            app.load_table.Position = [136 290 143 113];

            % Create load_single
            app.load_single = uihtml(app.ClassifierMainPanel);
            app.load_single.DataChangedFcn = createCallbackFcn(app, @Image21_2Clicked, true);
            app.load_single.Position = [136 114 143 123];
            ...
            % Create Label_13
            app.Label_13 = uilabel(app.ExcelEntry);
            app.Label_13.FontWeight = 'bold';
            app.Label_13.FontAngle = 'italic';
            app.Label_13.Position = [348 37 615 22];
            app.Label_13.Text = '';
            ...
            app.Class2Label_2.Visible = 'off';
            app.Class2Label_2.Position = [348 23 196 16];
            app.Class2Label_2.Text = '*Class 2';

            % Create Label_11
            app.Label_11 = uilabel(app.ExcelEntry);
            app.Label_11.FontWeight = 'bold';
            app.Label_11.FontAngle = 'italic';
            app.Label_11.FontColor = [1 0 0];
            app.Label_11.Position = [349 -3 25 22];
            app.Label_11.Text = '';

            % Create ExportClassesButton_4
            app.ExportClassesButton_4 = uibutton(app.ExcelEntry, 'push');
            app.ExportClassesButton_4.ButtonPushedFcn = createCallbackFcn(app, @ExportClassesButton_4Pushed, true);
            app.ExportClassesButton_4.BackgroundColor = [0 0 1];
            app.ExportClassesButton_4.FontWeight = 'bold';
            app.ExportClassesButton_4.FontColor = [1 1 1];
            app.ExportClassesButton_4.Visible = 'off';
            app.ExportClassesButton_4.Position = [264 -9 53 61];
            app.ExportClassesButton_4.Text = {'Export Classes'; ''};

            % Create classes_res
            app.classes_res = uihtml(app.ExcelEntry);
            app.classes_res.Position = [398 1 817 30];
            ...
            % Create Label_12
            app.Label_12 = uilabel(app.ExcelEntryPanel_2);
            app.Label_12.FontName = 'Arial';
            app.Label_12.FontWeight = 'bold';
            app.Label_12.FontAngle = 'italic';
            app.Label_12.FontColor = [0 1 0];
            app.Label_12.Position = [240 43 270 22];
            app.Label_12.Text = '';
            ...
            app.ResultsPanel_2.Position = [27 67 395 462];
            ...
            app.Image26.Position = [11 105 51 55];
            ...
            app.Panel_6.Position = [1 179 164 301];

            % Create UserManualLabel
            app.UserManualLabel = uilabel(app.Panel_6);
            app.UserManualLabel.FontWeight = 'bold';
            app.UserManualLabel.Visible = 'off';
            app.UserManualLabel.Position = [59 244 79 22];
            app.UserManualLabel.Text = 'User Manual';

            % Create sidebar_html
            app.sidebar_html = uihtml(app.Panel_6);
            app.sidebar_html.HTMLSource = '{}';
            app.sidebar_html.Position = [1 5 173 281];

            % Create HTML
            app.HTML = uihtml(app.GliomaIDHMutationDiagnosisToolUIFigure);
            app.HTML.HTMLSource = '{}';
            app.HTML.Position = [61 88 104 80];

            % Create HTML2
            app.HTML2 = uihtml(app.GliomaIDHMutationDiagnosisToolUIFigure);
            app.HTML2.HTMLSource = '<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1"><style>.btn {  background-color: transparent;  border: none;  color: black;  padding: 8px 16px;  text-align: center;  font-size: 16px;  margin: 2px 2px;  transition: 0.3s;}.btn:hover {  background-color: #3e8e41;  color: white;}.cd:hover {color:white;}</style></head><body><button class="btn"><a class="cd" style="text-decoration:none" href="https://www.w3schools.com/howto/tryit.asp?filename=tryhow_css_buttons_fade3"  target=''_blank''>Documentation</a></button></body></html>';
            app.HTML2.Position = [11 24 142 48];
