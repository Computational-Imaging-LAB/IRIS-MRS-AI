...
cvp = cvpartition(response, 'Holdout', HoldOut,'Stratify',true);
trainingPredictors = predictors(cvp.training, :);
trainingResponse = response(cvp.training, :);
trainingIsCategoricalPredictor = isCategoricalPredictor;

try
classificationKNN = fitcsvm(...
    trainingPredictors, ...
    trainingResponse, ...
...
predictorstest = predictors(cvp.test, :);
response = response(cvp.test, :)

[validationPredictions, validationScores] = trainedClassifier.predictFcn(predictorstest);
